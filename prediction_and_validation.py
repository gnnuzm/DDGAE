...
# 对score排序
TOPK = 30
drug_id = np.loadtxt('Data/drug_708.txt', dtype=str)
protein_id = np.loadtxt('Data/protein_1512.txt', dtype=str)
...
drug_dict_path = 'Data/drug_dict_map.txt'
target_dict_path = 'Data/protein_dict_map.txt'
...
for i in range(drug_num):
    ...
    drug_candidate_target = np.concatenate(
        (first_column, second_column, third_column, forth_column, fifth_column, sixth_column), axis=1)
